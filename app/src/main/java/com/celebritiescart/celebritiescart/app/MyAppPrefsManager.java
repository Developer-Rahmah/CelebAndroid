...
import static com.celebritiescart.celebritiescart.network.APIClient.BASE_URL;
import static com.celebritiescart.celebritiescart.network.APIClient.createNewRetrofitInstance;
...
//            ConstantValues.ECOMMERCE_URL = "https://ecommerce.mystaging.me/rest/ae/V1/";
            BASE_URL = ConstantValues.AR_ECOMMERCE_URL;
            createNewRetrofitInstance(BASE_URL);
        }
        else
            if(langID == 1) {
//            ConstantValues.ECOMMERCE_URL = "https://ecommerce.mystaging.me/rest/V1/";
            BASE_URL = ConstantValues.ECOMMERCE_URL;
            createNewRetrofitInstance(BASE_URL);
    ...
    public String getLocalNotificationsTitle() {
        return sharedPreferences.getString(LOCAL_NOTIFICATIONS_TITLE, "Qiotic");
    }
