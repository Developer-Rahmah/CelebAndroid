...
public class SubCategoryListAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.sub_category_layout = convertView.findViewById(R.id.sub_category_layout);
            holder.sub_category_image = convertView.findViewById(R.id.sub_category_image);
            holder.sub_category_title = convertView.findViewById(R.id.sub_category_title);
            holder.sub_category_products = convertView.findViewById(R.id.sub_category_products);
        ...
        Glide.with(context)
                .load(subCategoriesList.get(position).getImage())
