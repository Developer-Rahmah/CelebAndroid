...
import com.celebritiescart.celebritiescart.models.order_model.PostProductsAttributes;
...
public class OrderedProductsListAdapter extends RecyclerView.Adapter<OrderedProductsListAdapter.MyViewHolder> {
    ...
    holder.checkout_item_quantity .setTypeface(Typeface.createFromAsset(
                this.context.getAssets(),
                "font/baskvill_regular.OTF"
        ));

        holder.checkout_item_price.setTypeface(Typeface.createFromAsset(
                this.context.getAssets(),
                "font/baskvill_regular.OTF"
        ));

        holder.checkout_item_price_final.setTypeface(Typeface.createFromAsset(
                this.context.getAssets(),
                "font/baskvill_regular.OTF"
        ));
