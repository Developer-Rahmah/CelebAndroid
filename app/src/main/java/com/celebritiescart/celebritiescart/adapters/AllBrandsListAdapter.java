...
public class AllBrandsListAdapter extends RecyclerView.Adapter<AllBrandsListAdapter.MyViewHolder> {
    ...
    public AllBrandsListAdapter(Context context, List<CategoryDetails> categoriesList, boolean isSubCategory) {
    ...
    public MyViewHolder onCreateViewHolder(final ViewGroup parent, int viewType) {
        ...
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_brands_all, parent, false);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
     ...
     /*       Bundle categoryInfo = new Bundle();
            ...
            fragmentManager.beginTransaction()
                    ...
                    .addToBackStack(context.getString(R.string.actionBrands)).commit();*/
