...
import com.celebritiescart.celebritiescart.fragments.Add_Address;
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.edit_address.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                addressInfo.putString("addressState", addressDetails.getCountryName());
                addressInfo.putString("addressCity", addressDetails.getCity());
                addressInfo.putString("addressStreet", addressDetails.getStreet().get(0));
